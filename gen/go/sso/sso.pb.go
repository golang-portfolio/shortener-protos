...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x0e, 0x73, 0x68, 0x6f, 0x72, 0x74, 0x65, 0x6e, 0x65, 0x72, 0x5f, 0x61, 0x75, 0x74, 0x68, 0x22,
	...
	0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x69, 0x73, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x32, 0xe7,
	0x01, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12, 0x4d, 0x0a, 0x08, 0x52, 0x65, 0x67, 0x69, 0x73,
	0x74, 0x65, 0x72, 0x12, 0x1f, 0x2e, 0x73, 0x68, 0x6f, 0x72, 0x74, 0x65, 0x6e, 0x65, 0x72, 0x5f,
	...
	0x1c, 0x2e, 0x73, 0x68, 0x6f, 0x72, 0x74, 0x65, 0x6e, 0x65, 0x72, 0x5f, 0x61, 0x75, 0x74, 0x68,
	0x2e, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1d, 0x2e,
	0x73, 0x68, 0x6f, 0x72, 0x74, 0x65, 0x6e, 0x65, 0x72, 0x5f, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x4c,
	0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x4a, 0x0a, 0x07,
	0x49, 0x73, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x12, 0x1e, 0x2e, 0x73, 0x68, 0x6f, 0x72, 0x74, 0x65,
	0x6e, 0x65, 0x72, 0x5f, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x49, 0x73, 0x41, 0x64, 0x6d, 0x69, 0x6e,
	...
	0x65, 0x72, 0x5f, 0x61, 0x75, 0x74, 0x68, 0x5f, 0x76, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_sso_sso_proto_goTypes = []any{
	(*RegisterRequest)(nil),  // 0: shortener_auth.RegisterRequest
	(*RegisterResponse)(nil), // 1: shortener_auth.RegisterResponse
	(*LoginRequest)(nil),     // 2: shortener_auth.LoginRequest
	(*LoginResponse)(nil),    // 3: shortener_auth.LoginResponse
	(*IsAdminRequest)(nil),   // 4: shortener_auth.IsAdminRequest
	(*IsAdminResponse)(nil),  // 5: shortener_auth.IsAdminResponse
}
var file_sso_sso_proto_depIdxs = []int32{
	0, // 0: shortener_auth.Auth.Register:input_type -> shortener_auth.RegisterRequest
	2, // 1: shortener_auth.Auth.Login:input_type -> shortener_auth.LoginRequest
	4, // 2: shortener_auth.Auth.IsAdmin:input_type -> shortener_auth.IsAdminRequest
	1, // 3: shortener_auth.Auth.Register:output_type -> shortener_auth.RegisterResponse
	3, // 4: shortener_auth.Auth.Login:output_type -> shortener_auth.LoginResponse
	5, // 5: shortener_auth.Auth.IsAdmin:output_type -> shortener_auth.IsAdminResponse
